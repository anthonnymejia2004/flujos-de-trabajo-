...
@section('title')
    Agregar Producto - {{ \App\Models\UserSetting::get('empresa_nombre', 'Pharma-Sync') }}
@endsection
...
@section('content')
    <div class="max-w-5xl mx-auto px-4 py-8">
        <!-- Encabezado -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-slate-900 dark:text-white">Agregar Nuevo Producto</h1>
            <p class="text-slate-600 dark:text-slate-400 mt-2">Completa los datos del producto incluyendo inventario fraccionado</p>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <select 
                            ...
                            class="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-700 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        >
                            <option value="Caja" {{ old('package_type') == 'Caja' ? 'selected' : '' }}>Caja</option>
                            <option value="Sobre" {{ old('package_type') == 'Sobre' ? 'selected' : '' }}>Sobre</option>
                            <option value="Ampolla" {{ old('package_type') == 'Ampolla' ? 'selected' : '' }}>Ampolla</option>
                            <option value="Frasco" {{ old('package_type') == 'Frasco' ? 'selected' : '' }}>Frasco</option>
                            <option value="Blíster" {{ old('package_type') == 'Blíster' ? 'selected' : '' }}>Blíster</option>
                            <option value="Tubo" {{ old('package_type') == 'Tubo' ? 'selected' : '' }}>Tubo</option>
                            <option value="Pomo" {{ old('package_type') == 'Pomo' ? 'selected' : '' }}>Pomo</option>
                            <option value="Otros" {{ old('package_type') == 'Otros' ? 'selected' : '' }}>Otros</option>
                        </select>
                    ...
                    <input type="hidden" id="presentation" name="presentation" value="">
                    <script>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            step="1"
                            class="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-700 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                            placeholder="Ej: 20, 30, 50..."
                            value="{{ old('units_per_box') }}"
                        >
                        <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">¿Cuántas pastillas/comprimidos trae cada caja?</p>
                        <p id="units_per_box_warning" class="text-amber-600 dark:text-amber-400 text-xs mt-1 hidden">
                            ⚠️ Si cada caja trae solo 1 unidad, considera usar "Stock Suelto" en su lugar
                        </p>
                        @error('units_per_box')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="md:col-span-3">
                        <div class="bg-white dark:bg-slate-700 rounded-lg p-4 border border-blue-300 dark:border-blue-600">
                            ...
                            <p class="text-2xl font-bold text-blue-600 dark:text-blue-400">
                                <span id="total_units">0</span> unidades
                            </p>
                            <p class="text-xs text-slate-500 dark:text-slate-400 mt-2">
                                (<span id="total_boxes_units">0</span> en cajas + <span id="total_loose">0</span> sueltas)
                            </p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            value="0"
                        >
                        <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">Precio por unidad individual</p>
                    </div>
